...
doc db_thread_cache {
    ...
    Description {
	This cache mechanism differs from the <proc>db_cache</proc> in that this cache expires when the thread exists whereas the other cache mechanism has an explicit time-to-live.
	<p>
	The procs 
	<ul>
	<li><proc>db_thread_cache_1row</proc>
	<li><proc>db_thread_cache_0or1row</proc>
	<li><proc>db_thread_cache_foreach</proc> and
	<li><proc>db_thread_cache_select_table</proc>
	</ul>
    ...
    "See Also" {
	<proc>db</proc> and <proc>db_cache</proc>
    }
}
