...
proc qc::json2tson {json} {
    return [qc::json::json2tson $json]
}

namespace eval qc::json {
...
#           (@see http://json.org/)
proc qc::json::validate {jsonText} {
    variable validJsonRE

    return [regexp -- $validJsonRE $jsonText]
}

proc qc::json::json2tson {jsonText} {
...
proc qc::json::unexpected {tokenCursor token expected} {
...
proc qc::json::unquoteUnescapeString {token} {
...
proc qc::json::parseObjectMember {tokens nrTokens tokenCursorName objectDictName} {
...
#                       representing the JSON object of which to
#                       parse the next member
proc qc::json::parseObjectMembers {tokens nrTokens tokenCursorName objectDictName} {
    upvar $tokenCursorName tokenCursor
    upvar $objectDictName objectDict
...
proc qc::json::parseObject {tokens nrTokens tokenCursorName} {
    upvar $tokenCursorName tokenCursor
...
proc qc::json::parseArrayElements {tokens nrTokens tokenCursorName resultName} {
    upvar $tokenCursorName tokenCursor
...
proc qc::json::parseArray {tokens nrTokens tokenCursorName} {
    upvar $tokenCursorName tokenCursor
...
proc qc::json::parseValue {tokens nrTokens tokenCursorName} {
    #| Return tson object
    upvar $tokenCursorName tokenCursor
    ...
    if {$tokenCursor == $nrTokens} {
        ...
        switch -exact -- $leadingChar {
            "\{" {
                return [linsert [parseObject $tokens $nrTokens tokenCursor] 0 object]
            }
            "\[" {
                return [linsert [parseArray $tokens $nrTokens tokenCursor] 0 array]
            }
            "\"" {
                # quoted string
                return [list string [unquoteUnescapeString $token]]
            }
            "t" -
            "f" -
            "n" {
